...
- [You dont know JS](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/ch1.md)
...
- [React Performance Tips](https://react.dev/learn/optimizing-performance)
...
- [Blog Starter Template](https://github.com/vercel/next.js/tree/canary/examples/blog-starter)
...
- [REST API Best Practices](https://github.com/trekhleb/nodejs-rest-api-boilerplate)
...
- [OAuth Explained](https://www.digitalocean.com/community/tutorials/oauth-2-0)
...
- [Terraform Basics](https://developer.hashicorp.com/terraform)

---

## 12. VS Code & Productivity

- [Top Extensions](https://github.com/viatsko/awesome-vscode)
- [Settings Sync](https://marketplace.visualstudio.com/items?itemName=Shan.code-settings-sync)
- [Multi-cursor Editing Tips](https://code.visualstudio.com/docs/editor/codebasics)
...
- [Real-world APIs](https://github.com/public-apis/public-apis)
- [Build a Blog, E-Commerce, Chat App, etc.]
